...
Les codes programm\'es et d'autres codes choisis au hazard sont tap\'es au clavier avant, pendant et après l'application des perturbations de tests afin de v\'erifier la r\'eaction du clavier. 
...
Fr\'equence : balayage de 30MHz à 1Ghz\\
...
Fr\'equence : balayage de 0.15 MHz à 80 MHz\\
Modulation d'amplitude 80 \% 1kHz sinusoîdal\\
...
%\\
%\includegraphics[scale=1]{ERH24AC.jpg}
%\\
...
%\\
%\includegraphics[scale=1]{ERV24AC.jpg}
%\\
\\
\newpage
...
Fr\'equence : analyse de 0.15 MHz à 30 MHz\\
\\
...
%\\
%\includegraphics[scale=1]{ECL24AC.jpg}
...
%\\
%\includegraphics[scale=1]{ECN24AC.jpg}
\\
