...
c<-as.character(c)
vec<-c=="NC"
if (any(vec)==TRUE) res<-"n'est pas conforme à la directive 2014/30/UE." else res<-"est conforme à la directive 2014/30/UE."
...
\\
\noindent
Equipement de test :  Profline système SCHAFFNER\\
...
Fréquence : balayage de 30MHz à 1Ghz\\
...
Fréquence : balayage de 0.15 MHz à 80 MHz\\
Modulation d'amplitude 80 \% 1kHz sinusoîdal\\
...
Fréquence : analyse de 0.15 MHz à 30 MHz\\
\\
...
\\
\caption{Fig 1 -- Carte électronique - Face composants}


\includegraphics[scale=1]{2.jpg}
\\
\caption{Fig 2 -- Carte électronique - Face soudures}
...
\\
\caption{Fig 3 -- Essai d'immunité aux transitoires rapides en salves sur les entrées BT}
...
\\
\caption{Fig 6 -- Essai d'immunité aux décharges électrostatiques}
...
\\
\caption{Fig 8 -- Essai d'immunité aux ondes de choc sur les entrée du réseau BT}

\includegraphics[scale=0.5]{4-5LI.jpg}
\\
\caption{Fig 9 -- Essai d'immunité aux ondes de choc sur les lignes d'interconnexion}

\includegraphics[scale=0.5]{4-6.jpg}
\\
\caption{Fig 10 -- Essai d'immunité aux champs électromagnétiques conduits}
 
 
\includegraphics[scale=0.5]{4-3.jpg}
\\
\caption{Fig 11 -- Essai d'immunité aux champs électromagnétiques rayonnés}
